...
typedef Buffer* (*DataRequest)(uint8_t reportId);
typedef void (*DataReceived)(Buffer* data);
...
/** @defgroup USB_CORE_Exported_Functions
  * @{
  */
extern uint8_t USBD_CUSTOM_HID_SendReport (USBD_HandleTypeDef* pdev, uint8_t* report,
                                    uint16_t len);


extern uint8_t USBD_CUSTOM_HID_RegisterInterface (USBD_HandleTypeDef* pdev,
