namespace AvalonStudio.MVVM.DataVirtualization
{
    ...
    public class VirtualizingCollection<T> : ViewModel, IList<DataWrapper<T>>, IList where T : class
    {
        ...
        public VirtualizingCollection(IItemsProvider<T> itemsProvider, int pageSize, int pageTimeout)
        {
            ...
            _itemsProvider.PropertyChanged += new PropertyChangedEventHandler(_itemsProvider_PropertyChanged);
            _pageSize = pageSize;
        ...
        void _itemsProvider_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
        ...
        public void CleanPagesAround(ulong index)
        {
            ...
            var keysToRemove = _pages.Keys.Where((p) => p != pageIndex).ToList();
        ...
        public Dictionary<int, DataPage<T>> Pages
        {
            get
            {
                return _pages;
