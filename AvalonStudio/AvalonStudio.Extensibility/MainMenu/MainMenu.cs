namespace AvalonStudio.Extensibility
{
    ...
    public class MenuDefinitions : IExtension
    {
        ...
        public static readonly MenuDefinition FileMenu = new MenuDefinition(MainMenuBar, 0, "File");
        ...
        public static readonly MenuDefinition EditMenu = new MenuDefinition(MainMenuBar, 1, "Edit");

        public static readonly MenuItemGroupDefinition EditUndoRedoMenuGroup = new MenuItemGroupDefinition(EditMenu, 0);

        public static readonly MenuDefinition ViewMenu = new MenuDefinition(MainMenuBar, 2, "View");
        ...
        public static readonly MenuDefinition ToolsMenu = new MenuDefinition(MainMenuBar, 10, "Tools");

        public static readonly MenuDefinition WindowMenu = new MenuDefinition(MainMenuBar, 20, "Window");

        public static readonly MenuItemGroupDefinition WindowDocumentListMenuGroup = new MenuItemGroupDefinition(WindowMenu, 10);

        public static readonly MenuDefinition HelpMenu = new MenuDefinition(MainMenuBar, 30, "Help");
