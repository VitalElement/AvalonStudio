    ...
    public class STM32GCCToolchain : GCCToolchain
    {
        ...
        public override List<string> GetToolchainIncludes()
        {
            return new List<string>()
            {
                ...
                Path.Combine(Platform.ReposDirectory, "AvalonStudio.Toolchains.STM32", "arm-none-eabi", "include", "c++", "5.2.1", "arm-none-eabi", "thumb"),
                Path.Combine(Platform.ReposDirectory, "AvalonStudio.Toolchains.STM32", "lib", "gcc", "arm-none-eabi", "5.2.1", "include")                
            };
        }
