	...
	public class ToolTipBehavior : Behavior<Control>
	{
		...
		private void InitControls()
		{
			popup = new Popup
			{
				...
				//note: set popup.PlacementTarget to the AssociatedObject, the tooltip will derive formatting                
			};
		...
		private ToolTip CreateWrapperControl()
		{
			...
			//wire max width
			CreateBinding(MaxWidthProperty, Layoutable.MaxWidthProperty, tt);
		...
		public static readonly AvaloniaProperty ContentProperty =
			AvaloniaProperty.Register<ToolTipBehavior, object>(nameof(Content), string.Empty);
		...
		public static readonly AvaloniaProperty ContentStringFormatProperty =
			AvaloniaProperty.Register<ToolTipBehavior, string>(nameof(ContentStringFormat));
		...
		public static readonly AvaloniaProperty TitleProperty =
			AvaloniaProperty.Register<ToolTipBehavior, object>(nameof(Header), string.Empty);
		...
		/// </summary>
		public static readonly AvaloniaProperty TitleStringFormatProperty =
			AvaloniaProperty.Register<ToolTipBehavior, string>(nameof(TitleStringFormat));
		...
		/// </summary>
		public static readonly AvaloniaProperty MaxWidthProperty =
			AvaloniaProperty.Register<ToolTipBehavior, double>(nameof(MaxWidth));
		...
		public static readonly AvaloniaProperty DelayProperty = AvaloniaProperty.Register<ToolTipBehavior, int>(
			nameof(Delay), 500, false, BindingMode.TwoWay, ValidateDelay, OnDelayChanged);
		...
		public static readonly AvaloniaProperty IsInteractiveProperty =
			AvaloniaProperty.Register<ToolTipBehavior, bool>(nameof(IsInteractive), true, false, BindingMode.OneWay, null,
		...
		public static readonly AvaloniaProperty IsEnabledProperty =
			AvaloniaProperty.Register<ToolTipBehavior, bool>(nameof(IsEnabled), true, false, BindingMode.OneWay, null,
				OnIsEnabledChanged);
