...
namespace AvalonStudio.Shell.Commands
{
	public static class ToolBarDefinitions
	{
		...
		public static ToolBarItemDefinition SaveFileToolBarItem = new CommandToolBarItemDefinition
			<SaveFileCommandDefinition>(
			StandardOpenSaveToolBarGroup, 2);

		public static ToolBarItemDefinition SaveAllToolBarItem = new CommandToolBarItemDefinition
		...
		public static ToolBarItemDefinition CommentToolBarItem = new CommandToolBarItemDefinition
			<CommentCommandDefinition>(
			StandardEditGroup, 2);

		public static ToolBarItemDefinition UnCommentToolBarItem = new CommandToolBarItemDefinition
		...
		public static ToolBarItemDefinition BuildToolBarItem = new CommandToolBarItemDefinition
			<BuildCommandDefinition>(
			StandardBuildGroup, 0);

		public static ToolBarItemDefinition CleanToolBarItem = new CommandToolBarItemDefinition
