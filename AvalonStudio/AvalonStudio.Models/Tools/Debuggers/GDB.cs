...
{
    public class GDBDebugger : Debugger
    {
        public GDBDebugger()
        {
        ...
        public override List<MemoryBytes> ReadMemoryBytes(ulong address, ulong offset, uint count)
        {
        ...
        public override List<VariableObjectChange> UpdateVariables()
        {
        ...
        public override List<Variable> ListStackVariables()
        {
        ...
        public override List<Frame> ListStackFrames()
        {
        ...
        public override LiveBreakPoint BreakMain()
        {
        ...
        public override event EventHandler<StopRecord> Stopped;
        private event EventHandler<StopRecord> InternalStopped;

        public override LiveBreakPoint SetBreakPoint(string file, uint line)
        {
        ...
        public override void Remove(LiveBreakPoint breakPoint)
        {
            SafelyExecuteCommand(() => new RemoveBreakPointCommand(breakPoint).Execute(this));
        }

        public override DebuggerState State { get { return CurrentState; } }

        public override event EventHandler<EventArgs> StateChanged;

        public override Dictionary<int, Register> GetRegisters()
        {
        ...
        public override Dictionary<int, string> GetChangedRegisters()
        {
        ...
        public override List<InstructionLine> Disassemble(string file, int line, int numLines)
        {
        ...
        public override List<InstructionLine> Disassemble(ulong start, uint count)
        {
            List<InstructionLine> result = null;
        ...
        public override VariableObject CreateWatch(string id, string expression)
        {
            ...
            if (result.Response == ResponseCode.Done)
            {
                ...
                new VerSetFormatCommand(id, "natural").Execute(this);
        ...
        public override void SetWatchFormat(string id, WatchFormat format)
        {
            ...
            new VerSetFormatCommand(id, formatString).Execute(this);
        }
